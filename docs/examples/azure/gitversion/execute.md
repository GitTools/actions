...
> The examples use version _3.0.0_ of the GitVersion Execute task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion/setup@3.0.0 task omitted for brevity.

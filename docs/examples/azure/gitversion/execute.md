...
> The examples use version _4.4.0_ of the GitVersion Execute task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion-setup@4.4.0 task omitted for brevity.

  - task: gitversion-execute@4.4.0

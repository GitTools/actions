...
> The examples use version _3.1.10_ of the GitVersion Execute task.  It is recommended to use the latest released version in your own workflows.
...
steps:
  ...
  - task: gitversion/execute@3.1.10

...
> The examples use version _4.6.0_ of the GitVersion Setup task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
versionSpec:
  description: Required version in the form of 6.8.x or exact version like 6.8.0.
  required: true
  default: ''
includePrerelease:

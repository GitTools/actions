...
> The examples use version _1.2.0_ of the GitVersion Execute task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion/setup@1.2.0 task omitted for brevity.

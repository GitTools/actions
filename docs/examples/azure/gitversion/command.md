...
> The examples use version _3.1.6_ of the GitVersion Command task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion/setup@3.1.6 task omitted for brevity.

  - task: gitversion/command@3.1.6

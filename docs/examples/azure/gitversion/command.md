...
> The examples use version _4.4.1_ of the GitVersion Command task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion-setup@4.4.1 task omitted for brevity.

  - task: gitversion-command@4.4.1

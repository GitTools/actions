...
> The examples use version _3.0.2_ of the GitVersion Command task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gitversion/setup@3.0.2 task omitted for brevity.

  - task: gitversion/command@3.0.2

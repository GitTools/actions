...
> The examples use version _4.7.0_ of the GitReleaseManager Setup task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  - task: gitreleasemanager-setup@4.7.0

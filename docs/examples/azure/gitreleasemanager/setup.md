...
> The examples use version _3.0.1_ of the GitReleaseManager Setup task.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  - task: gitreleasemanager/setup@3.0.1

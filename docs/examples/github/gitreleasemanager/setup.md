...
> The examples use version _4.6.0_ of the GitReleaseManager Setup action.  It is recommended to use the latest released version in your own workflows.
...
steps:
  - name: Install GitReleaseManager
    uses: gittools/actions/gitreleasemanager/setup@v4.6.0
    with:
      versionSpec: '0.20.x'
```

...
steps:
  ...
  - name: Install GitVersion
    uses: gittools/actions/gitversion/setup@v4.4.0
    with:
      versionSpec: '6.6.x'
```
...
> The examples use version _4.4.0_ of the GitVersion Execute action.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gittools/actions/gitversion/setup@v4.4.0 action omitted for brevity.

  - name: Determine Version
    id: version_step # step id used as a reference for output values
    uses: gittools/actions/gitversion/execute@v4.4.0
```

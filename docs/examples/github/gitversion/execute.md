...
> The examples use version _3.3.0_ of the GitVersion Execute action.  It is recommended to use the latest released version in your own workflows.
...
steps:
  ...
  - name: Determine Version
    ...
    uses: gittools/actions/gitversion/execute@v3.3.0
```

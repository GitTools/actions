...
> The examples use version _4.4.0_ of the GitVersion Command action.  It is recommended to use the latest released version in your own workflows.
...
steps:
  ...
  - name: Display GitVersion config
    uses: gittools/actions/gitversion/command@v4.4.0
    with:

...
> The examples use version _3.1.1_ of the GitVersion Command action.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gittools/actions/gitversion/setup@v3.1.1 action omitted for brevity.

...
> The examples use version _3.0.1_ of the GitVersion Command action.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gittools/actions/gitversion/setup@v3.0.1 action omitted for brevity.

  - name: Display GitVersion config
    uses: gittools/actions/gitversion/command@v3.0.1
    with:
      useConfigFile: true

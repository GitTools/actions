...
> The examples use version _4.5.0_ of the GitVersion Command action.  It is recommended to use the latest released version in your own workflows.
...
steps:
  ...
  - name: Display GitVersion config
    uses: gittools/actions/gitversion/command@v4.5.0
    with:

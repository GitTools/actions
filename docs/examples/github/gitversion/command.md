...
> The examples use version _4.3.1_ of the GitVersion Command action.  It is recommended to use the latest released version in your own workflows.
...
```yaml
steps:
  # gittools/actions/gitversion/setup@v4.3.1 action omitted for brevity.

  - name: Display GitVersion config
    uses: gittools/actions/gitversion/command@v4.3.1
    with:

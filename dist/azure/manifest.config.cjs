module.exports = (env) => {
    ...
    return {
        ...
        files: [
            ...
            ...gitversion.map(task => ({ path: '../tools/rolldown-runtime.mjs', packagePath: `${task.path}/tools/rolldown-runtime.mjs` })),
            ...
            ...gitreleasemanager.map(task => ({ path: '../tools/rolldown-runtime.mjs', packagePath: `${task.path}/tools/rolldown-runtime.mjs` })),
        ],
        categories: [
            'Azure Pipelines'
        ],

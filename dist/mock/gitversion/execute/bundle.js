...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/tasks/gitversion/execute.ts");
/******/ })
/************************************************************************/
/******/ ({
...
const gitversion_tool_1 = __webpack_require__(/*! ../../tools/gitversion/gitversion-tool */ "./src/tools/gitversion/gitversion-tool.ts");
const ioc_1 = __importDefault(__webpack_require__(/*! ../../core/ioc */ "./src/core/ioc.ts"));
ioc_1.default.bind(common_1.TYPES.IGitVersionTool).to(gitversion_tool_1.GitVersionTool);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const inputOptions = gitVersionTool.getGitVersionInput();
...
/***/ "./src/tools/gitversion/gitversion-tool.ts":
/*!*************************************************!*\
  !*** ./src/tools/gitversion/gitversion-tool.ts ***!
  \*************************************************/
/*! no static exports found */
...
let GitVersionTool = class GitVersionTool {
    ...
    getGitVersionInput() {
        const targetPath = this.buildAgent.getInput(models_1.GitVersionRunOptions.targetPath);
        const useConfigFile = this.buildAgent.getBooleanInput(models_1.GitVersionRunOptions.useConfigFile);
        const configFilePath = this.buildAgent.getInput(models_1.GitVersionRunOptions.configFilePath);
        const updateAssemblyInfo = this.buildAgent.getBooleanInput(models_1.GitVersionRunOptions.updateAssemblyInfo);
        const updateAssemblyInfoFilename = this.buildAgent.getInput(models_1.GitVersionRunOptions.updateAssemblyInfoFilename);
        const additionalArguments = this.buildAgent.getInput(models_1.GitVersionRunOptions.additionalArguments);

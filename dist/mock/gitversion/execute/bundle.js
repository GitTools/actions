...
let BuildAgent = class BuildAgent {
    ...
    exec(exec, args, additionalArguments) {
...
let DotnetTool = DotnetTool_1 = class DotnetTool {
    ...
    execute(cmd, args, additionalArgs = '') {

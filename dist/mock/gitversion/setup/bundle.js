...
DotnetTool = __decorate([
    ...
    __param(1, inversify_1.inject(common_1.TYPES.IVersionManager)),
...
const dotnet_tool_1 = __webpack_require__(/*! ./dotnet-tool */ "./src/core/dotnet-tool.ts");
const container = new inversify_1.Container();
container.bind(common_1.TYPES.IVersionManager).to(versionManager_1.VersionManager);
container.bind(common_1.TYPES.IBuildAgent).to(build_agent_1.BuildAgent);
container.bind(common_1.TYPES.IDotnetTool).to(dotnet_tool_1.DotnetTool);
...
const gitversion_1 = __webpack_require__(/*! ../../tools/gitversion */ "./src/tools/gitversion.ts");
const ioc_1 = __importDefault(__webpack_require__(/*! ../../core/ioc */ "./src/core/ioc.ts"));
ioc_1.default.bind(common_1.TYPES.IGitVersionTool).to(gitversion_1.GitVersionTool);
const gitVersionTool = ioc_1.default.get(common_1.TYPES.IGitVersionTool);
const buildAgent = ioc_1.default.get(common_1.TYPES.IBuildAgent);
function setup() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
let GitVersionTool = class GitVersionTool {
    ...
    getGitVersionOptions() {
        const targetPath = this.buildAgent.getInput(exports.GitVersionRunOptions.targetPath);
        const useConfigFile = this.buildAgent.getBooleanInput(exports.GitVersionRunOptions.useConfigFile);
        const configFilePath = this.buildAgent.getInput(exports.GitVersionRunOptions.configFilePath);
        const updateAssemblyInfo = this.buildAgent.getBooleanInput(exports.GitVersionRunOptions.updateAssemblyInfo);
        const updateAssemblyInfoFilename = this.buildAgent.getInput(exports.GitVersionRunOptions.updateAssemblyInfoFilename);
        const additionalArguments = this.buildAgent.getInput(exports.GitVersionRunOptions.additionalArguments);

...
let GitReleaseManagerTool = class GitReleaseManagerTool {
    ...
    getCreateArguments(settings) {
        const args = [...this.getCommonArguments(settings)];

...
var ArgumentsBuilder = class {
	...
	*/
	addKeyValue(key, value) {
		if (key && value !== void 0 && value !== null) this.args.push(`--${key}`, value);
		return this;
	}
	/**
	...
	*/
	addCommaList(key, values) {
		if (key && values && values.length > 0) this.args.push(`--${key}`, values.join(","));
		return this;
	}
	/**
...
//#endregion
export { ArgumentsBuilder, DotnetTool, RunnerBase, SettingsProvider, keysOf };
